...
Toolmaking, together with bipedalism and language, was once regarded as a defining feature that makes humans distinct from other species. It is also often portrayed as the pinnacle in the evolution of cognition and creativity. Although this simple notion of human uniqueness and its associated linear evolutionary narrative was overturned in the past decades by mounting evidence of toolmaking by non-human primates and corvids [@shumaker2024], particularly in the domain of food foraging, the higher-order cases of tool manufacture (i.e., using existing tools to make other tools) as well as the recruitment of toolmaking process for novel functions [@davidson2005] has not been recorded in any species other than the human lineage. In terms of time allocation of tool-use and toomaking as well as the level of dependency in caloric intake [@shipman2010], toolmaking occupies a central niche in our daily activities as compared with other toolmaking species.

On top of the basic survival need, it is also critical to human experience in the sense that a biocultural feedback loop is formed through toolmaking that shapes our minds and bodies. human experience: Engaging with the works of Malafouris [@malafouris2012; @ihde2019] and philosophy of technology [@lee2009; @birch2021].
