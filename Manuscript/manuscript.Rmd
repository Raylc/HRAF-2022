...
> "For the initiates, the marginal period is a time of education…Then the
elders systematically teach the initiates to make all the different kinds of basketry (carrying baskets, sieves, flat trays, cassava squeezers, etc.)… In addition to basketry, the initiates are taught how to make the feather head-dresses and other ritual ornaments used in dances…Just before the blowing of pepper, the initiates are taught to weave conical fish traps which they go and set in streams in the forest, accompanied by their masori."
